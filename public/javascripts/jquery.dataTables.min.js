...
sSortableDesc:"ui-state-default",sSortableNone:"ui-state-default",sSortColumn:"sorting_",sSortJUIAsc:"right ui-icon ui-icon-triangle-1-n",sSortJUIDesc:"right ui-icon ui-icon-triangle-1-s",sSortJUI:"right ui-icon ui-icon-carat-2-n-s",sSortJUIAscAllowed:"right ui-icon ui-icon-carat-1-n",sSortJUIDescAllowed:"right ui-icon ui-icon-carat-1-s",sSortJUIWrapper:"DataTables_sort_wrapper",sScrollWrapper:"dataTables_scroll",sScrollHead:"dataTables_scrollHead ui-state-default",sScrollHeadInner:"dataTables_scrollHeadInner",

...
KE.event.ready(function() {
	...
	orderType.options[0] = new Option('创建日期', 'created_at');
	orderType.options[1] = new Option(lang.fileName, 'asset_filename');
	orderType.options[2] = new Option(lang.fileSize, 'asset_filesize');
	orderType.options[3] = new Option(lang.fileType, 'asset_contenttype');

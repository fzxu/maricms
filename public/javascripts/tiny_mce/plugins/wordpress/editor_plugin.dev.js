...
(function() {
	...
	tinymce.create('tinymce.plugins.WordPress', {
		...
		init : function(ed, url) {
			var t = this, tbId = ed.getParam('wordpress_adv_toolbar', 'toolbar2'), tbId2 = ed.getParam('wordpress_adv_toolbar', 'toolbar3'), last = 0, moreHTML, nextpageHTML;
			...
			ed.addCommand('WP_Adv', function() {
				...
				if ( 'undefined' == id || 'undefined' == id2)
					return;

				if ( DOM.isHidden(id) && DOM.isHidden(id2)) {

...
class ImageStyleTest < ActiveSupport::TestCase
  ...
  test "test create only parent image style" do
    is = ImageStyle.new(:key => "slider", :name => "For Slide Show on Home page", :width => 800, :height => 600, :quality => 90, :crop => true)
    assert is.valid?
    is.save
  ...
  test "test create the parent and child at the same time" do
    is = ImageStyle.new(:key => "slider", :name => "For Slide Show on Home page", :width => 800, :height => 600, :quality => 80, :crop => true,
    :child_image_styles => [
      {:key => "icon", :name => "Small icon use", :width => 80, :height => 80, :quality => 70, :crop => true}
    ])
    assert is.valid?
    is.save
    is.reload
  ...
  test "test create image style with versions" do
    is = ImageStyle.new(:key => "slider", :name => "For Slide Show on Home page", :width => 800, :height => 600, :quality => 80, :crop => false)
    icon = ImageStyle.new(:key => "icon", :name => "Small icon use", :width => 80, :height => 80, :quality => 90, :crop => true)
    enlarge = ImageStyle.new(:key => "enlarge", :name => "Large", :width => 1920, :height => 1080, :quality => 80, :crop => false)
  ...
  test "test generate default uploader class" do
    default = ImageStyle.new(:key => "default", :name => "Default", :width => 1920, :height => 1080, :quality => 100, :crop => false, :quality => 100)
